...
4. For "game tick tock tae","tic tac toe","ttt","start gam" -> action:"ttt", react:"🎮", reply:""
5. For "ping" -> action:"ping", react:"⚡", reply:""
6. For "menu","help" -> action:"menu", react:"📋", reply:""
7. For "owa kaka embu tuma dp yangu" -> action:"getProfilePic", target:"sender", react:"🖼️", reply:""
8. If TikTok link detected -> action:"tiktok", react:"⏬", reply:""
9. If Facebook link detected -> action:"facebook", react:"⏬", reply:""
10. If Instagram link detected -> action:"instagram", react:"⏬", reply:""
11. NEVER write "Task completed", "Done", "Here is", "Starting" in reply field unless action is "chat".
12. "react" must be single emoji related to action.
13. If no case matches -> action:"chat", react:"💬", reply:"your answer"
14. Bot can reply to itself. Allow self-referential actions but never reply to processing/edit status messages.
